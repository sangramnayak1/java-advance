...
public class CookieObjectsRegistrationServlet1 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Cookie c1 = new Cookie("firstName", fn);
		Cookie c2 = new Cookie("lasttName", ln);
		...
		pw.println("<form action = \"cookieRegistrationServlet2\">");
